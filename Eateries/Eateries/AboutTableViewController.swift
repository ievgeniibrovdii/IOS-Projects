...
class AboutTableViewController: UITableViewController {
    ...
    let sectionsHeaders = ["We are in social networks", "Our sites"]
    let sectionsContent = [["facebook", "vk", "youtube"], ["swiftbook.ru", "forum.swiftbook.ru"]]
    let firstSectionLinks = ["https://www.facebook.com/", "https://vk.com", "https://www.youtube.com/channel/UCIdvVrmAanoGJKUyOzpfjPQ?"]
